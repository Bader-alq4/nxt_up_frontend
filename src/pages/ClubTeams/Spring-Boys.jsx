...
export default function SpringBoys() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="program-container">
        ...
        <section className="program-hero">
          <div className="program-hero-text">
            ...
            <p className="program-lead">
              A long-term development partnership built to support competitive boys athletes
        ...
        <section className="program-section">
          ...
          <div className="tournament-option-block">
            ...
            <ul className="simple-list">
              <li>Las Vegas Live or another U.S. tournament (TBD)</li>
              <li>Projected dates: July 9–12 or early to mid July</li>
            </ul>
          </div>
        </section>
